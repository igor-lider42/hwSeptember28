public class Main {
    ...
    //При этом для пользователей с телефоном с 2015 года выпуска нужно вывести обычное
    ...
    public static void task2() {
        int clientOS = 0;
        int clientDeiceYar = 2020;

        if (clientOS == 0) {
            if (clientDeiceYar < 2015) {
    ...
    //Задание 4
    //Вернемся к делам банковским. У нас хороший банк, поэтому для наших клиентов
    // мы организуем доставку банковских карт на дом с четкой датой доставки.
